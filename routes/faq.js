...
router.get("/:userID/fetch/all", authMiddleware, checkUserExistence, fetchAllFAQs);
router.get("/:userID/fetch/single/:FAQID", authMiddleware, checkUserExistence, fetchFAQByID);
